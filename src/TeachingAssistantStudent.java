...
public class TeachingAssistantStudent extends Student {
	...
	// value. It also updates the instance variable hours when a course is
	// added.
	...
	public void addCourseHour(String course, int hours) throws ArrayElementException {
		...
		if(courseHour != null && courseHour.containsKey(course)){
	...
	public void printCourses() {
		...
		for (String courses : courseHour.keySet()) {
			System.out.println(courses +"              "+ courseHour.get(courses));
		}
